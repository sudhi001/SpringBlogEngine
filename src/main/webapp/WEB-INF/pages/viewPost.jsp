                ...
                <div class="row">
                   <div class="col-xs-12 text-right">
                      <c:if test="${commentItem.parentCommentId != null && commentItem.parentCommentId.length() > 0}">
                         <button class="btn btn-sm" onclick="loadArticleComment('${articleModel.articleId}', '${commentItem.parentCommentId}', 'Article', '#prevComment_${commentItem.commentId}', '${pageContext.request.contextPath}')">Previous Comment/Reply</button>
                      </c:if>
